...
# ANSWER:
# It evaluated to true because loves_to_play is equal to true AND also age is 1, which is less than 2. 
# Each comparison/variable on each side of the logical operator is true, so the whole statement evaluates to true.
